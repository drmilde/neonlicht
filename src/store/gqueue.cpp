...
class ConsumerThread : public GenericThread
{
    GenericQueue<WorkItem*>& m_queue;
 
  public:
    ConsumerThread(GenericQueue<WorkItem*>& queue) : m_queue(queue) {}
